...
window.onload = function () {
  ...
  var maxQuestionCount = 20,
    ...
    displayFinalResult = document.getElementById("container1"),
    nextButton = document.getElementById('next1'),
    questionElement = document.getElementById('question1'),
    replyElement = document.getElementById('answer1'),
    questionCountElement = document.getElementById('question_count1'),
